...
ActiveRecord::Schema.define(version: 20190313163016) do
  ...
  create_view "ministers", sql_definition: <<-SQL
      select `role_appointments`.`id` AS `role_appointments_id`,`role_appointments`.`role_id` AS `role_appointments_role_id`,`role_appointments`.`person_id` AS `role_appointments_person_id`,`role_appointments`.`created_at` AS `role_appointments_created_at`,`role_appointments`.`updated_at` AS `role_appointments_updated_at`,`role_appointments`.`started_at` AS `role_appointments_started_at`,`role_appointments`.`ended_at` AS `role_appointments_ended_at`,`role_appointments`.`content_id` AS `role_appointments_content_id`,`roles`.`id` AS `roles_id`,`roles`.`created_at` AS `roles_created_at`,`roles`.`updated_at` AS `roles_updated_at`,`roles`.`type` AS `roles_type`,`roles`.`permanent_secretary` AS `roles_permanent_secretary`,`roles`.`cabinet_member` AS `roles_cabinet_member`,`roles`.`slug` AS `roles_slug`,`roles`.`chief_of_the_defence_staff` AS `roles_chief_of_the_defence_staff`,`roles`.`whip_organisation_id` AS `roles_whip_organisation_id`,`roles`.`seniority` AS `roles_seniority`,`roles`.`attends_cabinet_type_id` AS `roles_attends_cabinet_type_id`,`roles`.`role_payment_type_id` AS `roles_role_payment_type_id`,`roles`.`supports_historical_accounts` AS `roles_supports_historical_accounts`,`roles`.`whip_ordering` AS `roles_whip_ordering`,`roles`.`content_id` AS `roles_content_id`,`organisations`.`id` AS `organisations_id`,`organisations`.`url` AS `organisations_url`,`organisations`.`alternative_format_contact_email` AS `organisations_alternative_format_contact_email`,`organisations`.`govuk_status` AS `organisations_govuk_status`,`organisations`.`organisation_logo_type_id` AS `organisations_organisation_logo_type_id`,`organisations`.`analytics_identifier` AS `organisations_analytics_identifier`,`organisations`.`handles_fatalities` AS `organisations_handles_fatalities`,`organisations`.`important_board_members` AS `organisations_important_board_members`,`organisations`.`default_news_organisation_image_data_id` AS `organisations_default_news_organisation_image_data_id`,`organisations`.`closed_at` AS `organisations_closed_at`,`organisations`.`organisation_brand_colour_id` AS `organisations_organisation_brand_colour_id`,`organisations`.`ocpa_regulated` AS `organisations_ocpa_regulated`,`organisations`.`public_meetings` AS `organisations_public_meetings`,`organisations`.`public_minutes` AS `organisations_public_minutes`,`organisations`.`register_of_interests` AS `organisations_register_of_interests`,`organisations`.`regulatory_function` AS `organisations_regulatory_function`,`organisations`.`logo` AS `organisations_logo`,`organisations`.`organisation_type_key` AS `organisations_organisation_type_key`,`organisations`.`foi_exempt` AS `organisations_foi_exempt`,`organisations`.`organisation_chart_url` AS `organisations_organisation_chart_url`,`organisations`.`govuk_closed_status` AS `organisations_govuk_closed_status`,`organisations`.`custom_jobs_url` AS `organisations_custom_jobs_url`,`organisations`.`content_id` AS `organisations_content_id`,`organisations`.`homepage_type` AS `organisations_homepage_type`,`organisations`.`political` AS `organisations_political`,`organisations`.`ministerial_ordering` AS `organisations_ministerial_ordering`,`role_translations`.`id` AS `role_translations_id`,`role_translations`.`role_id` AS `role_translations_role_id`,`role_translations`.`locale` AS `role_translations_locale`,`role_translations`.`name` AS `role_translations_name`,`role_translations`.`responsibilities` AS `role_translations_responsibilities`,`role_translations`.`created_at` AS `role_translations_created_at`,`role_translations`.`updated_at` AS `role_translations_updated_at`,`people`.`id` AS `people_id`,`people`.`title` AS `people_title`,`people`.`forename` AS `people_forename`,`people`.`surname` AS `people_surname`,`people`.`letters` AS `people_letters`,`people`.`created_at` AS `people_created_at`,`people`.`updated_at` AS `people_updated_at`,`people`.`carrierwave_image` AS `people_carrierwave_image`,`people`.`slug` AS `people_slug`,`people`.`privy_counsellor` AS `people_privy_counsellor`,`people`.`content_id` AS `people_content_id`,`organisations_role_appointments`.`id` AS `organisations_role_appointments_id`,`organisations_role_appointments`.`created_at` AS `organisations_role_appointments_created_at`,`organisations_role_appointments`.`updated_at` AS `organisations_role_appointments_updated_at`,`organisations_role_appointments`.`slug` AS `organisations_role_appointments_slug`,`organisations_role_appointments`.`url` AS `organisations_role_appointments_url`,`organisations_role_appointments`.`alternative_format_contact_email` AS `organisations_role_appointments_alternative_format_contact_email`,`organisations_role_appointments`.`govuk_status` AS `organisations_role_appointments_govuk_status`,`organisations_role_appointments`.`organisation_logo_type_id` AS `organisations_role_appointments_organisation_logo_type_id`,`organisations_role_appointments`.`analytics_identifier` AS `organisations_role_appointments_analytics_identifier`,`organisations_role_appointments`.`handles_fatalities` AS `organisations_role_appointments_handles_fatalities`,`organisations_role_appointments`.`important_board_members` AS `organisations_role_appointments_important_board_members`,`organisations_role_appointments`.`default_news_organisation_image_data_id` AS `organisations_role_appointments_news_organisation_img_data_id`,`organisations_role_appointments`.`closed_at` AS `organisations_role_appointments_closed_at`,`organisations_role_appointments`.`organisation_brand_colour_id` AS `organisations_role_appointments_organisation_brand_colour_id`,`organisations_role_appointments`.`ocpa_regulated` AS `organisations_role_appointments_ocpa_regulated`,`organisations_role_appointments`.`public_meetings` AS `organisations_role_appointments_public_meetings`,`organisations_role_appointments`.`public_minutes` AS `organisations_role_appointments_public_minutes`,`organisations_role_appointments`.`register_of_interests` AS `organisations_role_appointments_register_of_interests`,`organisations_role_appointments`.`regulatory_function` AS `organisations_role_appointments_regulatory_function`,`organisations_role_appointments`.`logo` AS `organisations_role_appointments_logo`,`organisations_role_appointments`.`organisation_type_key` AS `organisations_role_appointments_organisation_type_key`,`organisations_role_appointments`.`foi_exempt` AS `organisations_role_appointments_foi_exempt`,`organisations_role_appointments`.`organisation_chart_url` AS `organisations_role_appointments_organisation_chart_url`,`organisations_role_appointments`.`govuk_closed_status` AS `organisations_role_appointments_govuk_closed_status`,`organisations_role_appointments`.`custom_jobs_url` AS `organisations_role_appointments_custom_jobs_url`,`organisations_role_appointments`.`content_id` AS `organisations_role_appointments_content_id`,`organisations_role_appointments`.`homepage_type` AS `organisations_role_appointments_homepage_type`,`organisations_role_appointments`.`political` AS `organisations_role_appointments_political`,`organisations_role_appointments`.`ministerial_ordering` AS `organisations_role_appointments_ministerial_ordering`,`organisation_translations`.`id` AS `organisation_translations_id`,`organisation_translations`.`organisation_id` AS `organisation_translations_organisation_id`,`organisation_translations`.`locale` AS `organisation_translations_locale`,`organisation_translations`.`name` AS `organisation_translations_name`,`organisation_translations`.`logo_formatted_name` AS `organisation_translations_logo_formatted_name`,`organisation_translations`.`acronym` AS `organisation_translations_acronym`,`organisation_translations`.`created_at` AS `organisation_translations_created_at`,`organisation_translations`.`updated_at` AS `organisation_translations_updated_at` from (((((((((`role_appointments` left join `roles` on((`roles`.`id` = `role_appointments`.`role_id`))) left join `organisation_roles` on((`organisation_roles`.`role_id` = `roles`.`id`))) left join `organisations` on((`organisations`.`id` = `organisation_roles`.`organisation_id`))) left join `role_translations` on((`role_translations`.`role_id` = `roles`.`id`))) left join `people` on((`people`.`id` = `role_appointments`.`person_id`))) left join `roles` `roles_role_appointments_join` on((`roles_role_appointments_join`.`id` = `role_appointments`.`role_id`))) left join `organisation_roles` `organisation_roles_role_appointments_join` on((`organisation_roles_role_appointments_join`.`role_id` = `roles_role_appointments_join`.`id`))) left join `organisations` `organisations_role_appointments` on((`organisations_role_appointments`.`id` = `organisation_roles_role_appointments_join`.`organisation_id`))) left join `organisation_translations` on((`organisation_translations`.`organisation_id` = `organisations_role_appointments`.`id`))) where ((`roles`.`type` = 'MinisterialRole') and (`organisation_translations`.`locale` in ('cy','en')) and (`role_translations`.`locale` in ('arbg','cs','cy','de','dr','el','en','es','es-419','fr','hi','hy','id','it','ja','ko','lt','lv','pl','pt','ro','ru','so','sq','th','tr','uk','ur','zh','zh-tw'))) order by `people`.`surname`,`people`.`forename`
  SQL
end
